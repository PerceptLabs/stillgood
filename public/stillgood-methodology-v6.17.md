...
**Benchmark profile:** `6.17.0-upper-reserve`  
...
at least 88, every core category is at least 88, memory remains top-grade
...
support is experimental. Version 6.17 applies no browser-name multiplier,
...
serious weakness. Memory and persistent storage are asymmetric diagnostics:
