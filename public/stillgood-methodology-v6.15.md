...
**Benchmark profile:** `6.15.0-adaptive-media-headroom`  
**Published:** July 2026
...
- SG-branded local H.264 video playback from 480p through an adaptive 4K headroom tier;
...
Version 6.15 applies no browser-name multiplier, offset, cap exception, or
...
mechanismsâ€”text, layout, arrays, formulas, memory, and renderingâ€”but LibreOffice
