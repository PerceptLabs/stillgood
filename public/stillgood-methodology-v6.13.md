...
- memory-pressure foreground probes and copy times;
...
Version 6.13 applies no browser-name multiplier, offset, cap exception, or
...
grade as if it were a direct SSD benchmark.
