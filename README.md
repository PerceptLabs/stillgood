...
Results include an A–E rating, category evidence, highest comfortable office
workload sizes, practical role guidance, JSON export, and a printable detailed
report.
...
`docs/`, with `docs/15_BENCHMARK_V4_OFFICE_WORKLOADS.md` describing the current
office workload revision.
