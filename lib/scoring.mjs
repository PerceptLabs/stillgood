 ...
 * genuinely exceptional evidence. Scores through 90 are unchanged. Above 90,
...
export function calibrateTopEndScore1000(score1000) {
  ...
  if (normalized <= 900) return normalized;
  const anchors = [
    { input: 900, output: 900 },
    { input: 940, output: 930 },
    { input: 980, output: 960 },
    { input: 990, output: 980 },
...
export function summarizeThoroughRun(metrics) {
  ...
  const broadCapabilityEvidenceCeiling1000 = boundedReserveVerified ? 1000 : 930;
  ...
  const internalScoring = {
    scale: 1000,
    aggregation: "normalized-weighted-geometric-with-calibrated-top-range-v3",
