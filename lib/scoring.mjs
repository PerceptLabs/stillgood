...
export function summarizeThoroughRun(metrics) {
  ...
  const confidence =
    metrics.interruptionCount > 0 || variability > 0.45
      ? "Low"
      : variability > 0.25 || metrics.longTaskCount > 30
        ? "Medium"
        : "High";
