...
export function summarizeThoroughRun(metrics) {
  ...
  const scoredCategories = [
    { score: email.score, weight: 0.2 },
    { score: writing.score, weight: 0.16 },
    { score: spreadsheets.score, weight: 0.16 },
    { score: multitasking.score, weight: 0.18 },
  ...
  const roles = [];
  if (email.score >= 58) roles.push("Large email websites");
