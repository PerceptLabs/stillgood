...
function gradeHeadline(grade, formFactor) {
  if (formFactor === "mobile") {
    if (["A+", "A"].includes(grade))
      return "Excellent mobile browser performance";
    if (grade === "A-") return "Very capable mobile browser performance";
    if (grade.startsWith("B")) return "Good mobile browser performance";
    return "Useful for lighter mobile browsing";
  }
  if (["A+", "A"].includes(grade)) return "Fast, modern-feeling computer";
  if (grade === "A-") return "Excellent second-life computer";
